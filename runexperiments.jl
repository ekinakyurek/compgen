...
function run(args=ARGS)
    ...
    s.description = "Sigmorphon Experiments"
    @add_arg_table! s begin
        ...
        ("--gradnorm"; arg_type=Float64; default=.0; help="global gradient norm clip, 0 for none")
        ("--writedrop"; arg_type=Float64; default=.1; help="write dropout in copy")
        ("--outdrop"; arg_type=Float64; default=.5; help="output dropout in rnn")
